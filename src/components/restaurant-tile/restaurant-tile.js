...
export const RestaurantTile = ({ hit, deleteRestaurant }) => (
  <div className="restaurant-tile" data-testid="restaurant-tile">
    <img
    ...
    <div className="restaurant-details">
      ...
      <button
        className="base-btn restaurant-delete-btn"
        data-testid="restaurant-delete"
        onClick={() => deleteRestaurant(hit.objectID)}>
        Delete
      </button>
    </div>
  </div>
